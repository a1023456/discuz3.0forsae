...
$_config['db']['1']['slave']['1']['dbhost'] = SAE_MYSQL_HOST_S.':'.SAE_MYSQL_PORT;
$_config['db']['1']['slave']['1']['dbuser'] = SAE_MYSQL_USER;
$_config['db']['1']['slave']['1']['dbpw'] = SAE_MYSQL_PASS;
$_config['db']['1']['slave']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['slave']['1']['pconnect'] = '0';
$_config['db']['1']['slave']['1']['dbname'] = SAE_MYSQL_DB;
$_config['db']['1']['slave']['1']['tablepre'] = 'sae_';
